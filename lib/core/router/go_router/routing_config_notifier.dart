...
import 'package:hiddify/features/limm/limm_diagnostic.dart';
              ...
              routes: <GoRoute>[
                GoRoute(
                  ...
                  routes: <GoRoute>[
                    ...
                    GoRoute(
                      name: 'limmDiagnostic',
                      path: 'limm-diagnostic',
                      pageBuilder: (_, state) =>
                          customTransition(TransitionType.slide, state.pageKey, const LimmDiagnosticPage()),
                    ),
                    if (isMobileBreakpoint) ...[
                      GoRoute(
                        name: 'logs',
